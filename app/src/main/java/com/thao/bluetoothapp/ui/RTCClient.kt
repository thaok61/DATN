...
class RTCClient(
    ...
    private var iceServerBuilder: IceServer.Builder = PeerConnection.IceServer.builder("stun:stun1.l.google.com:19302").setTlsCertPolicy(PeerConnection.TlsCertPolicy.TLS_CERT_POLICY_INSECURE_NO_CHECK)
